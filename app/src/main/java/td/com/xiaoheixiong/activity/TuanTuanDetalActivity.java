...
public class TuanTuanDetalActivity extends BaseActivity implements PullableRefreshScrollView.OnScrollChangeListener,PullLayout.OnRefreshListener{
    ...
    private CountdownView2 cd_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuantuan_detal);
        mContext = this;
    ...
    protected void initViews() {
        ...
        cd_time= (CountdownView2) findViewById(R.id.cd_time);
        ...
        progressview.setMaxCount(6);
        progressview.setCurrentCount(4);

        cd_time.start(639300404);
