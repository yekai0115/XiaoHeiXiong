package td.com.xiaoheixiong.views.popwindow;
...
public class TitlePopAdapter extends BaseAdapter{
	...
	public View getView(final int arg0, final View arg1, ViewGroup arg2) {
		...
		if(view==null){
			...
			holder.img_pop_item = (ImageView) view.findViewById(R.id.img_pop_item);
		...
		if(null!=mDrawable){
			...
			holder.img_pop_item.setVisibility(View.VISIBLE);
		}else{
...
//			holder.text.setLayoutParams(layoutParams);
			holder.img_pop_item.setVisibility(View.GONE);
		}
