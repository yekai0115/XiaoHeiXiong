...
/**
 * Created by 11832 on 2018/3/18.
 */

public class SpringProgressView extends View {

    /**分段颜色*/
    private static final int[] SECTION_COLORS = {Color.argb(255,255,90,0),Color.argb(255,255,0,0),Color.argb(255,255,0,0)};
    /**进度条最大值*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectBg, round, round, mPaint);//边框背景
        mPaint.setColor(getResources().getColor(R.color.tv_color21));
