 ...
 */
public class MiaomiaoRecyclerviewAdapter extends RecyclerView.Adapter<MiaomiaoRecyclerviewAdapter.mViewHolder> {
    ...
    // View view;
    public MiaomiaoRecyclerviewAdapter(Context context, ArrayList<HashMap<String, Object>> list, RecyclerViewItemTouchListener listener) {
        datas = list;
        mlistener = listener;
        mContext = context;
    }
