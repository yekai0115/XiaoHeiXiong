...
public class FragmentTabAdapter implements RadioGroup.OnCheckedChangeListener {
    ...
    private String tagsts = "", wecname = "", sts = "", lognum = "";
    ...
    public FragmentTabAdapter(FragmentActivity fragmentActivity, List<Fragment> fragments, int fragmentContentId,
                              RadioGroup rgs, List<RadioButton> radioview) {
    ...
    public void showTab(int idx) {
        ...
        // fragments.get(currentTab).setUserVisibleHint(false);
        currentTab = idx; // 更新目标tab为当前tab
        // fragments.get(currentTab).setUserVisibleHint(true);
    }
