 ...
 */
public class MerchatTypesAdapter extends RecyclerView.Adapter<MerchatTypesAdapter.mViewHolder> {
    ...
    // View view;
    public MerchatTypesAdapter(Context context, ArrayList<HashMap<String, Object>> list, RecyclerViewItemTouchListener listener) {
        datas = list;
        mlistener = listener;
        mContext = context;
    }
...
//        }
        view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_merchat_types, viewGroup, false);
        ...
        if (viewHolder != null && datas.size() > 0) {
            ...
            if (level < 5) {
                ...
                for (int i = 0; i < level - 7; i++) {
                    ...
                    LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(54, 48);
                    lp.setMargins(10, 0, 0, 0);
                    imgView.setLayoutParams(lp);
                    viewHolder.zhizun_ll.addView(imgView);
                }
...
//        }
    ...
    /*private void setBadgeView(String str, ImageView view) {
        ...
        if (!str.equals("0")) {
            ...
            if (Integer.parseInt(str) > 99) {
                ...
                badge.setTextSize(8);
                badge.setBackgroundResource(R.mipmap.reds_icon);
