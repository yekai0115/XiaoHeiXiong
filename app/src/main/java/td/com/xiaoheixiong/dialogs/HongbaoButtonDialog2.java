 ...
 * @author liangge
 */
public class HongbaoButtonDialog2 extends Dialog implements
    ...
    public HongbaoButtonDialog2(Context context, boolean cancelable,
                                OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        // TODO Auto-generated constructor stub
    }

    public HongbaoButtonDialog2(Context context, int theme,
                                String content,
    ...
    public HongbaoButtonDialog2(Context context,
                                String content,
                                OnMyDialogClickListener onMyDialogClickListener) {
        super(context);
        // TODO Auto-generated constructor stub
