package td.com.xiaoheixiong.wechatLogin;
...
public class WxShareAndLoginUtils {
    ...
    public static IWXAPI getWXAPI(){
        if (iwxapi == null){
            ...
            iwxapi = WXAPIFactory.createWXAPI(BNaviDemoApplication.getContext(), Config.APP_ID, true);
            //将应用的appid注册到微信
    ...
    private static boolean judgeCanGo(){
        ...
        if (!iwxapi.isWXAppInstalled()) {
            Toast.makeText(BNaviDemoApplication.getContext(), "请先安装微信应用", Toast.LENGTH_SHORT).show();
            return false;
        } else if (!iwxapi.isWXAppSupportAPI()) {
            Toast.makeText(BNaviDemoApplication.getContext(), "请先更新微信应用", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
